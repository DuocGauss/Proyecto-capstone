...
class MantencionVehiculo(models.Model):
    ...
    fecha_preventiva = models.DateField(default=timezone.now)
    fecha_correctiva = models.DateField(default=timezone.now)
    fecha_externa = models.DateField(default=timezone.now)
    hora_entrada_preventiva = models.TimeField(default='00:00:00')
    hora_salida_preventiva = models.TimeField(default='00:00:00')
    hora_entrada_correctiva = models.TimeField(default='00:00:00')
    hora_salida_correctiva = models.TimeField(default='00:00:00')
